...
## 4. Regra de Três
- Método prático para resolver proporções  
- **Simples:** uma razão direta ou inversa  
...
- Problemas envolvendo receitas, escalas, mapas  
- Velocidade, tempo e distância (grandezas inversamente proporcionais)  
- Comparação de preços, lucros e porcentagens  
- Resolução de questões com regra de três simples e composta

---

## 6. Dicas
- Sempre identificar se a relação é **direta ou inversa**  
- Transformar proporção em **frações equivalentes**  
- Verificar unidades para consistência
