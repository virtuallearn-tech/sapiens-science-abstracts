...
## 6. Conversão entre Fração, Decimal e Percentual
- Fração → Percentual: multiplicar por 100%  
- Decimal → Percentual: multiplicar por 100%  
- Percentual → Decimal: dividir por 100  

Ex.: 0,25 → 25%, 3/4 → 75%

---

## 7. Aplicações no ENEM
- Descontos, acréscimos e lucros  
- Comparação de dados estatísticos  
- Problemas de população, escalas e taxas  
- Juros simples e composto em economia doméstica

---

## 8. Resumo Final
- Porcentagem = razão com 100  
- Cálculo direto, acréscimos, descontos, variação  
- Conversão fração ↔ decimal ↔ percentual  
- Essencial para **problemas de finanças, estatística e interpretação de gráficos**
