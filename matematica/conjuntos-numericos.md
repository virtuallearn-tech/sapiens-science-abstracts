...
## 1. Conceito
Conjuntos numéricos são **grupos de números** com propriedades semelhantes, usados para organizar e classificar os números na matemática.
...
- Identificação de números racionais, irracionais, inteiros  
- Operações e intervalos numéricos  
- Problemas envolvendo união, interseção e complementos
